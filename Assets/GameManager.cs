...
public class GameManager
{
    ...
    public GameObject RootGameObject()
    {
        ...
        {
            _rootGameObject = GameObjectByName("Root");
        }
    ...
    public GameObject PlayerGameObject()
    {
        ...
        {
            _playerGameObject = GameObjectByName("Player");
        }
    ...
    public PlayerBehaviour PlayerBehaviour()
    {
        ...
        {
            _playerBehaviour = PlayerGameObject().GetComponent<PlayerBehaviour>();
        }
    ...
    public GameObject CameraGameObject()
    {
        ...
        {
            _cameraGameObject = GameObjectByName("Camera");
        }
